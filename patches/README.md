...
subdirectories specific to each version. Each subdirectory contains patche files named with a 3-digit sequence number
followed by the commit hash from which the patch was generated, separated by a hypnen. The image build process applies
